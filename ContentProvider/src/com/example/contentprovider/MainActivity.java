...
public class MainActivity extends Activity {
   ...
   private void createContact(String name, String phone) {
       ...
       Log.v("Log value of URI",""+ContactsContract.Contacts.CONTENT_URI);
       if (cur.getCount() > 0) {
           while (cur.moveToNext()) {
   ...
   private void updateContact(String name, String phone) {
       ...
       Toast.makeText(MainActivity.this, "Updated the phone number of 'Example Name' to: " + phone, Toast.LENGTH_SHORT).show();
   }
